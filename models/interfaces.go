...
type AuthRepository interface {
	...
	UpdateUserById(ctx context.Context, id primitive.ObjectID, field, value string) (*mongo.UpdateResult, error)
	...
	SignUpUser(ctx context.Context, user *SignUpInput) (*DBResponse, error)
}
